...
import com.bluecast.app.BlueCastApplication
import com.bluecast.app.R
...
class StreamingService : Service() {
    ...
    private val container by lazy { (application as BlueCastApplication).container }
    ...
    private fun ensureChannel() {
        ...
        val channel = NotificationChannel(
            ...
            description = "Shows the active BlueCast audio streaming session."
        }
    ...
    private fun buildNotification(): Notification {
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_bluecast_notification)
    ...
    companion object {
        const val ACTION_START = "com.bluecast.app.action.START_STREAMING"
        const val ACTION_STOP = "com.bluecast.app.action.STOP_STREAMING"

        private const val CHANNEL_ID = "bluecast_streaming"
