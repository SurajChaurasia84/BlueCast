...
import com.miccast.app.ui.MicCastApp
import com.miccast.app.ui.theme.MicCastTheme
import com.miccast.app.viewmodel.MicCastViewModel
...
class MainActivity : ComponentActivity() {
    ...
    private val viewModel: MicCastViewModel by viewModels {
        viewModelFactory {
            initializer {
                val app = application as MicCastApplication
                MicCastViewModel(
                    application = app,
